  ...
  if (this.markers_.length == 0) {
    // Only 1 marker in this cluster so show the marker.
		if (this.map_.getZoom()>5) {
			if (marker.information_.matched) {
				marker.setIcon('images/markers/white.png','near');
			} else {
				marker.setIcon('images/markers/yellow.png','near');
			}
		} else {
			if (marker.information_.matched) {
				marker.setIcon('images/markers/18_white.png','far');
			} else {
				marker.setIcon('images/markers/18_yellow.png','far');
			}
		}
